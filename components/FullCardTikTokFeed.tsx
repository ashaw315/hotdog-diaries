...
// Enhanced test videos with different aspect ratios and sources
const TEST_VIDEOS = [
  {
    id: -1,
  ...
  {
    id: -3,
    content_text: "Amazing hotdog assembly line",
    content_type: 'video' as ContentType,
    ...
    source_platform: 'imgur' as SourcePlatform,
    original_author: "factory_worker",
  ...
  {
    id: -4,
    content_text: "Gourmet hotdog creation process",
    content_type: 'video' as ContentType,
    content_video_url: "https://youtu.be/dQw4w9WgXcQ",
    content_image_url: "https://images.unsplash.com/photo-1612392061787-2d078b2cb4b4?w=800&h=600&fit=crop",
    source_platform: 'youtube' as SourcePlatform,
    original_author: "gourmet_chef",
    original_url: "https://example.com/test4",
    scraped_at: new Date(),
    is_posted: false,
    is_approved: true,
    posted_at: new Date()
...
export default function FullCardTikTokFeed() {
  ...
  return (
    <div className="page-container">
      {/* Fixed decorative text - black with upright letters */}
      {!isMobile && (
        <>
          <div className="decorative-text left-text">HOTDOG</div>
          <div className="decorative-text right-text">DIARIES</div>
      ...
      >
        {posts.map((post, index) => (
          <div key={post.id} className="full-card">
            <PostContent 
              post={post} 
...
function PostContent({ 
  ...
  const renderMedia = () => {
    ...
    // Video content with full card coverage
    if (post.content_type === 'video' && post.content_video_url && !videoError) {
      // YouTube videos - FULL card coverage
        ...
        if (videoId) {
          return (
            <iframe
              ...
              src={`https://www.youtube.com/embed/${videoId}?autoplay=${isActive ? 1 : 0}&mute=1&controls=1&rel=0&modestbranding=1&showinfo=0`}
      ...
      // Direct video files - FULL card coverage
      return (
        <video
          ref={videoRef}
    ...
    // Image content - FULL card coverage
  ...
  return (
    <div className="post-content">
      ...
      <style jsx>{`
        ...
        /* FULL CARD COVERAGE for all media */
        .full-video-iframe,
        .full-video,
        .full-image {
          width: 100%;
