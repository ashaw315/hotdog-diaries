...
// Enhanced test videos with proper YouTube handling
const TEST_VIDEOS = [
  {
    id: -1,
...
export default function DesignedTikTokFeed() {
  ...
  const scrollToPost = (index: number) => {
    if (containerRef.current) {
      const cardHeight = window.innerHeight * 0.85 + 40 // Card height + gap
  ...
  const handleScroll = () => {
    if (containerRef.current) {
      ...
      const cardHeight = window.innerHeight * 0.85 + 40
  ...
  if (loading) {
    return (
      <div className="page-container">
        <div className="decorative-text left-text">DIARIES</div>
        <div className="decorative-text right-text">HOTDOG</div>
...
function PostContent({ 
  ...
  const renderMedia = () => {
    ...
    if (post.content_type === 'video' && post.content_video_url && !videoError) {
      ...
      // If video URL doesn't match known patterns, fall back to thumbnail
        ...
        return (
          <div className="video-placeholder">
            <img 
              ...
              alt={post.content_text || 'Video thumbnail'}
  ...
  return (
    <div className="post-content">
      ...
      <style jsx>{`
        ...
        /* Consistent media sizing for both videos and images */
        .media-content {
          max-width: 100%;
          max-height: 70vh;
          width: auto;
        ...
        /* Video placeholder for unsupported formats */
        .video-placeholder {
          position: relative;
          display: flex;
          align-items: center;
